...
> Une réservation payée peut être modifiée par le patron (report, ajout ou
> suppression de participants), sur demande par téléphone. L'ajout de
> participants entraîne le paiement d'un supplément (lien de paiement envoyé par
> mail) ; la suppression de participants suit le circuit du remboursement.
...
- Ne couvre pas le remboursement d'une annulation → `SPEC-CANCEL-CLIENT-01`
...
- [ ] AC-2 — Le patron peut modifier une réservation payée.
