...
final class DisponibiliteService
{
    ...
    public function estReservable(Sortie $sortie, \DateTimeImmutable $maintenant): bool { return $sortie->getDate() === null || $sortie->getDate()->getTimestamp() - $maintenant->getTimestamp() > 3600; }
